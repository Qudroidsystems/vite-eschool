...
<div class="main-content">
    <div class="page-content">
                                    ...
                                    <table class="table align-middle table-row-dashed fs-6 gy-5 mb-0" id="kt_roles_view_table">
                                        ...
                                        <tbody class="fw-semibold text-gray-600 list form-check-all">
                                            ...
                                            @forelse ($schoolhouses as $sc)
                                                <tr data-url="{{ route('schoolhouse.deletehouse', ['houseid' => $sc->id]) }}">
                                                    ...
                                                    <td class="housecolour" data-housecolour="{{ $sc->housecolour }}">{{ $sc->housecolour }}</td>
                        ...
                        <form class="tablelist-form" autocomplete="off" id="add-house-form">
                            <div class="modal-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="housecolour" id="housecolour" class="form-control" placeholder="Enter house colour" required>
                                </div>
                                <div class="mb-3">
                        ...
                        <form class="tablelist-form" autocomplete="off" id="edit-house-form">
                            <div class="modal-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="housecolour" id="edit-housecolour" class="form-control" placeholder="Enter house colour" required>
                                </div>
                                <div class="mb-3">
        ...
        <script src="{{ asset('js/schoolhouse.init.js') }}"></script> --}}
    </div>
</div>
@endsection