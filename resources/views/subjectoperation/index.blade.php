    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <div id="subjectList">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="alert alert-info">
                                    ...
                                    Select the subjects you want to register students for. Only selected subjects will be used during registration.
                                </div>
                            ...
                            <div class="card-header d-flex align-items-center">
                                ...
                                <div class="flex-shrink-0">
                                    <div class="d-inline-flex align-items-center">
                                        <button type="button" class="btn btn-primary d-none" id="register-selected-btn" onclick="registerSelectedStudents();" aria-label="Register selected students">
                                            Register Selected
                                        </button>
                ...
                <div class="modal" id="registeredClassesModal">
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title">Registered Classes</h5>
