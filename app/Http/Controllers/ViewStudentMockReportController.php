...
class ViewStudentMockReportController extends Controller
{
    ...
    {
        $this->middleware('permission:View student-mock-report', ['only' => ['index', 'show']]);
    ...
    {
        $pagetitle = " Students Reports Management";
        ...
        return view('studentmockreports.index', compact('allstudents', 'term', 'session', 'schoolclass', 'studentcount', 'male', 'female', 'pagetitle'))
