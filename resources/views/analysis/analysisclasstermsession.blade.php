        ...
        <div id="kt_app_content" class="app-content flex-column-fluid">
            ...
            <div id="kt_app_content_container" class="app-container container-xxl">
                ...
                <div class="d-flex justify-content-end mb-5">
                    ...
                    <a href="{{ route('analysis.exportPDF', ['class_id' => request()->class_id, 'termid_id' => request()->termid_id, 'session_id' => request()->session_id, 'action' => 'download']) }}"
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5 mb-0" id="kt_roles_view_table">
                            ...
                            <tbody class="fw-semibold text-gray-600">
                                @foreach ($student as $stu)
                                    @php
                                        $studentTotalPaid = $studentpaymentbillbook->where('student_id', $stu->stid)->sum('amount_paid');
                                        $studentTotalBalance = $studentpaymentbillbook->where('student_id', $stu->stid)->sum('amount_owed');
                                    @endphp
                                    <tr>
                                        <td>
                ...
                <!--begin::Chart-->
                @if (!empty($totalBill) && !empty($totalBillBalance))
                    @php
