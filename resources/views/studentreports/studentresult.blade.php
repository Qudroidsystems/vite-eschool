                                ...
                                <tbody>
                                    @forelse ($scores as $index => $score)
                                        <tr>
                                            ...
                                            <td align="center" style="font-size: 14px;" @if ($score->ca1 < 40 && is_numeric($score->ca1)) class="highlight-red" @endif>{{ $score->ca1 ?? '-' }}</td>
                                            <td align="center" style="font-size: 14px;" @if ($score->ca2 < 40 && is_numeric($score->ca2)) class="highlight-red" @endif>{{ $score->ca2 ?? '-' }}</td>
                                            <td align="center" style="font-size: 14px;" @if ($score->ca3 < 40 && is_numeric($score->ca3)) class="highlight-red" @endif>{{ $score->ca3 ?? '-' }}</td>
                                            <td align="center" style="font-size: 14px;" @if ($score->ca1 && $score->ca2 && $score->ca3 && round(($score->ca1 + $score->ca2 + $score->ca3) / 3, 1) < 40) class="highlight-red" @endif>
                                                {{ $score->ca1 && $score->ca2 && $score->ca3 ? round(($score->ca1 + $score->ca2 + $score->ca3) / 3, 1) : '-' }}
                                            </td>
                                            <td align="center" style="font-size: 14px;" @if ($score->exam < 40 && is_numeric($score->exam)) class="highlight-red" @endif>{{ $score->exam ?? '-' }}</td>
                                            <td align="center" style="font-size: 14px;" @if ($score->total < 40 && is_numeric($score->total)) class="highlight-red" @endif>{{ $score->total ?? '-' }}</td>
                                            <td align="center" style="font-size: 14px;" @if ($score->bf < 40 && is_numeric($score->bf)) class="highlight-red" @endif>{{ $score->bf ?? '-' }}</td>
                                            <td align="center" style="font-size: 14px;" @if ($score->cum < 40 && is_numeric($score->cum)) class="highlight-red" @endif>{{ $score->cum ?? '-' }}</td>
