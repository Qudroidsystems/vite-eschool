        ...
        <div class="container-fluid">
                        ...
                        <div class="card-body z-1 position-relative">
                            <div class="d-flex">
                                ...
                                <div class="flex-shrink-0 mt-sm-0 mt-3">
                                    ...
                                    <h6><span class="text-muted fw-normal">Email:</span> <span id="email">{{ $schoolInfo->school_email ?? 'info@topclasscollege.edu' }}</span></h6>
                            ...
                            <div class="mt-5 pt-4">
                                <div class="row g-3">
                                    ...
                                    <div class="col-lg col-6">
                                        ...
                                        <span class="badge bg-success-subtle text-success fs-xxs" id="payment-status">
                                ...
                                <div class="row g-3">
                                    @if($studentdata->isNotEmpty())
                                        ...
                                        <div class="col-6">
                                            ...
                                            <h6 class="fs-md">{{ $s->firstname }} {{ $s->lastname }}</h6>
                                            <p class="text-muted mb-1">{{ nl2br(wordwrap($s->homeadd ?? 'N/A', 20, "\n", true)) }}</p>
                                ...
                                <table class="table table-borderless text-center table-nowrap align-middle mb-0">
                                    ...
                                    <tbody id="products-list">
                                        @if($studentpaymentbill->isEmpty())
                                            <tr>
                                                <td colspan="6" class="text-center text-muted">No bills available.</td>
                                            </tr>
                                        @else
                            ...
                            @if($studentpaymentbill->isNotEmpty())
                                <div class="mt-3">
                                    ...
                                    <p class="text-muted mb-0">Total Amount: <span class="fw-medium">₦</span><span id="card-total-amount">{{ number_format($totalBillAmount, 2, '.', ',') }}</span></p>
                                </div>
                            @endif
                            <div class="mt-4 mb-4">
                                <div class="alert alert-danger mb-0">
                                    <span class="fw-semibold">NOTES:</span>
                                    <span id="note">All accounts are to be paid within 7 days from receipt of invoice. Payments can be made via bank transfer, cash, or POS at the school office. Late payments may incur additional charges as per school policy.</span>
                                </div>
                            </div>
                            <div>
            ...
            document.addEventListener('DOMContentLoaded', function() {
                ...
                downloadButton.addEventListener('click', function() {
                    this.disabled = true;
                    this.innerHTML = '<i class="ri-download-2-line align-bottom me-1"></i> Downloading...';
                    window.location.href = '{{ url()->current() }}?download_pdf=1';
                    setTimeout(() => {
                        this.disabled = false;
